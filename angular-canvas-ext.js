...
canvasExtModule.factory('apPosition', [
  'apTypeHelper',
  function (apTypeHelper) {
...
canvasExtModule.factory('apSize', [
  'apTypeHelper',
  function (apTypeHelper) {
...
canvasExtModule.factory('apFrame', [
  'apTypeHelper',
  'apPosition',
  'apSize',
  function (apTypeHelper, apPosition, apSize) {
...
canvasExtModule.factory('apImageHelper', [
  '$rootScope',
  '$q',
  'apBrowserHelper',
  'apTypeHelper',
  ...
  'apSize',
  'apFrame',
  function ($rootScope, $q, apBrowserHelper, apTypeHelper, apPosition, apSize, apFrame) {
...
canvasExtModule.directive('apCanvas', [
  'apImageHelper',
  function (apImageHelper) {
    return {
      restrict: 'A',
      scope: {
        src: '=',
...
]);canvasExtModule.directive('apFileSrc', [
  'apImageHelper',
  function (apImageHelper) {
    return {
      restrict: 'A',
